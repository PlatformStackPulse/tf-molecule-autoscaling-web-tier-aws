...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_autoscaling_group"></a> [autoscaling\_group](#module\_autoscaling\_group) | git::https://github.com/PlatformStackPulse/tf-atom-autoscaling-group-aws.git | v1.1.0 |
| <a name="module_launch_template"></a> [launch\_template](#module\_launch\_template) | git::https://github.com/PlatformStackPulse/tf-atom-launch-template-aws.git | v1.1.0 |
| <a name="module_scaling_policy"></a> [scaling\_policy](#module\_scaling\_policy) | git::https://github.com/PlatformStackPulse/tf-atom-autoscaling-policy-aws.git | v1.1.0 |
...
| <a name="input_security_group_ids"></a> [security\_group\_ids](#input\_security\_group\_ids) | Security group IDs for instances | `list(string)` | n/a | yes |
| <a name="input_subnet_ids"></a> [subnet\_ids](#input\_subnet\_ids) | Private subnet IDs for the ASG | `list(string)` | n/a | yes |
...
| <a name="input_desired_capacity"></a> [desired\_capacity](#input\_desired\_capacity) | Desired instances | `number` | `2` | no |
...
| <a name="input_max_size"></a> [max\_size](#input\_max\_size) | Maximum instances | `number` | `6` | no |
| <a name="input_min_size"></a> [min\_size](#input\_min\_size) | Minimum instances | `number` | `2` | no |
...
| <a name="input_scaling_metric_type"></a> [scaling\_metric\_type](#input\_scaling\_metric\_type) | Metric for target tracking (ASGAverageCPUUtilization, ALBRequestCountPerTarget) | `string` | `"ASGAverageCPUUtilization"` | no |
| <a name="input_scaling_policy_enabled"></a> [scaling\_policy\_enabled](#input\_scaling\_policy\_enabled) | Whether to create a scaling policy | `bool` | `true` | no |
| <a name="input_scaling_target_value"></a> [scaling\_target\_value](#input\_scaling\_target\_value) | Target value for scaling metric | `number` | `70` | no |
| <a name="input_stage"></a> [stage](#input\_stage) | ID element. Usually used to indicate role, e.g. 'prod', 'staging', 'source', 'build', 'test', 'deploy', 'release'. | `string` | `null` | no |
| <a name="input_tags"></a> [tags](#input\_tags) | Additional tags (e.g. `{'BusinessUnit': 'XYZ'}`).<br/>Neither the tag keys nor the tag values will be modified by this module. | `map(string)` | `{}` | no |
| <a name="input_target_group_arns"></a> [target\_group\_arns](#input\_target\_group\_arns) | Target group ARNs to attach | `list(string)` | `[]` | no |
...
| <a name="output_autoscaling_group_name"></a> [autoscaling\_group\_name](#output\_autoscaling\_group\_name) | Name of the ASG |
